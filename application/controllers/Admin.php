...
class Admin extends CI_Controller {
    ...
    function transaksi_add_act(){
        ...
        $hargaperhari = $this->input->post('hargaperhari');
        ...
        $this->form_validation->set_rules('hargaperhari','Harga Per Hari','required');
        $this->form_validation->set_rules('denda','Denda','required');

        if($this->form_validation->run() != false){
            $pinjam      = strtotime($tgl_pinjam);
            $kembali     = strtotime($tgl_kembali);
            $lama_pinjam = abs(($pinjam - $kembali)/(60*60*24));
            $harga       = $hargaperhari * $lama_pinjam;
            ...
            $data = array(
                ...
                'transaksi_hargaperhari' => $hargaperhari,
    ...
    function laporan(){
        ...
        $sampai = $this->input->post('sampai');$this->form_validation->set_rules('dari','Dari Tanggal','required');
